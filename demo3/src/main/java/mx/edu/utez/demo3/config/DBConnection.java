...
public class DBConnection {
    ...
    private static final String URL      = "jdbc:oracle:thin:@fotq418u24jxqwe3_high";
    private static final String USER     = "ADMIN";
    private static final String PASSWORD = "jspxdvc8zdsm_OO";

    // Obtiene una conexión nueva
    public static Connection getConnection() throws SQLException {
        // 1. Apunta al directorio donde descomprimiste el wallet
        System.setProperty("oracle.net.tns_admin", "C:\\Users\\CC10\\Downloads\\JanE\\Wallet_FOTQ418U24JXQWE3");
